...
public class Test {
	...
	//private static String mApiKey = "4480afa9b8b364e30ba03819f3e9eff5";
	//private static String mApiSecret = "Pz9VFT8AP3g_Pz8_dz84cRY_bz8_Pz8M";

	public static void main(String[] args) {
		//replace api_key and api_secret here (note)
		
		HttpRequests httpRequests = new HttpRequests(mApiKey, mApiSecret, true, true);
		...
		try {
			...
			System.out.println(
					httpRequests.recognitionVerify(new PostParameters().setPersonName("person_6").setFaceId(
							result.getJSONArray("face").getJSONObject(0).getString("face_id"))));
